...
/// SSE event payload.  The `type` field discriminates each variant for JS
...
pub struct Job {
    ...
    /// SSE receiver — taken once; a second caller receives 409.
...
/// Create a new Running job and the sender used to push SSE events into it.
